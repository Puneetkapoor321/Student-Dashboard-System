    ...
    <AuthLayout>
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-2 text-center">Sign in to continue to SkillUp</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isPending ? <Loader2 className="w-5 h-5 animate-spin text-zinc-950" /> : 'Sign In'}
          </button>
        </form>
